...
public class EthicsQuiz extends JFrame implements ActionListener{
    JLabel lbl;  
...
void setnext() //function to set next question 
    {  
        ...
        try
        {
          ...
          pst=db.conn.prepareStatement("select * from tbl_ethics");
            if(current==0)  
            {    
                String sql="select * from tbl_ethics where Q_No=1"; 
            ...
            if(current==1)  
            {  
                String sql="select * from tbl_ethics where Q_No=2";
                 pst=db.conn.prepareStatement(sql);
                ResultSet rs = pst.executeQuery(sql);
                if(rs.next()){
                String s1 =rs.getString("question");
            ...
            if(current==2)  
            {  
                String sql="select * from tbl_ethics where Q_No=3";
                 pst=db.conn.prepareStatement(sql);
            ...
            if(current==3)  
            {  
                String sql="select * from tbl_ethics where Q_No=4";
                 pst=db.conn.prepareStatement(sql);
                ResultSet rs = pst.executeQuery();
                if(rs.next()){
                String s1 =rs.getString("question");
            ...
            if(current==4)  
            {  
                String sql="select * from tbl_ethics where Q_No=5";
                 pst=db.conn.prepareStatement(sql);
                ResultSet rs = pst.executeQuery();
                if(rs.next()){
                String s1 =rs.getString("question");
            ...
            if(current==5)  
            {  
                String sql="select * from tbl_ethics where Q_No=6";
                 pst=db.conn.prepareStatement(sql);
                ResultSet rs = pst.executeQuery();
                if(rs.next()){
                String s1 =rs.getString("question");
            ...
            if(current==6)  
            {  
                String sql="select * from tbl_ethics where Q_No=7";
                pst=db.conn.prepareStatement(sql);
                ResultSet rs = pst.executeQuery();
                if(rs.next()){
                String s1 =rs.getString("question");
            ...
            if(current==7)  
            {  
                String sql="select * from tbl_ethics where Q_No=8";
                 pst=db.conn.prepareStatement(sql);
                ResultSet rs = pst.executeQuery();
                if(rs.next()){
                String s1 =rs.getString("question");
            ...
            if(current==8)  
            {  
                String sql="select * from tbl_ethics where Q_No=9";
                 pst=db.conn.prepareStatement(sql);
                ResultSet rs = pst.executeQuery();
                if(rs.next()){
                String s1 =rs.getString("question");
            ...
            if(current==9)  
            {  
                String sql="select * from tbl_ethics where Q_No=10";
                pst=db.conn.prepareStatement(sql);
                rs = pst.executeQuery();
                if(rs.next()){
                String s1 =rs.getString("question");
