    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource().equals(btnadd))
        {
            ...
            int result;
                ...
                if(com.getSelectedItem().equals("Ethics"))
                {
                    result=db.addEthics(txtques.getText(),txtopt1.getText(),txtopt2.getText(),txtopt3.getText(),txtopt4.getText(),txtcorrectans.getText());
                    if(result>0)
                    {
                        JOptionPane.showMessageDialog(null,"Question added in Ethics");
                        return;
                    }
                }
            
                  if(com.getSelectedItem().equals("Modern Web"))
                {
                    result=db.addmodern(txtques.getText(),txtopt1.getText(),txtopt2.getText(),txtopt3.getText(),txtopt4.getText(),txtcorrectans.getText());
                    if(result>0)
                    {
                        JOptionPane.showMessageDialog(null,"Question added in Modern Web");
                        return;
                    }
                }
    
                 if(com.getSelectedItem().equals("DDW"))
                {
                    result=db.addddw(txtques.getText(),txtopt1.getText(),txtopt2.getText(),txtopt3.getText(),txtopt4.getText(),txtcorrectans.getText());
                    if(result>0)
                    {
                        JOptionPane.showMessageDialog(null,"Question added in DDW");
                        return;
                    }
                }
